...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mygatewayapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mygatewayapp API";

        private String description = "mygatewayapp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mygatewayapp";
